...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
        ...
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('itel/itel-daily-upfront') }}'><i class="las la-balance-scale"></i> Itel Daily Upfronts</a></li>
    </ul>
</li>
@endif
...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('itel_expense/itel-expense') }}'><i class="las la-user-tie"></i> Itel expenses</a></li>
    </ul>
</li>
@endif
...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('grameenphone/grammenphone-product') }}'><i class="las la-sim-card"></i></i> GP Products</a></li>
    </ul>
</li>
@endif
...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('grameenphone/grameenphone-sales') }}'><i class="las la-sim-card"></i></i> Daily sales</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('grameenphone/gp-daily-sale') }}'><i class="las la-sim-card"></i></i> Daily Sold</a></li>
...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('gp_expense/gp-expense') }}'><i class="las la-user-tie"></i> Expense</a></li>
    </ul>
</li>
@endif
